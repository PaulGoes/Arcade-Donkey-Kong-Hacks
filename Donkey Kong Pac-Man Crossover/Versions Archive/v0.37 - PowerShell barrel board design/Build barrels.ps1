...
$girderarray = @( (0x02,0x3F,0xD7,0x10,0xD5),(0x02,0xBF,0xD8,0x40,0xD8),(0x02,0xDF,0xDA,0xC0,0xD8), # girder 1
                  (0x02,0x3F,0xB9,0x20,0xBA),(0x02,0xBF,0xB8,0x40,0xB8),(0x02,0xEF,0xB5,0xC0,0xB7), # girder 2
                  (0x02,0x3F,0x97,0x10,0x95),(0x02,0xBF,0x98,0x40,0x98),(0x02,0xDF,0x9A,0xC0,0x98), # girder 3
                  (0x02,0x3F,0x79,0x20,0x7A),(0x02,0xBF,0x78,0x40,0x78),(0x02,0xEF,0x75,0xC0,0x77), # girder 4
                  (0x06,0xBF,0xD0,0x40,0xD0),(0x06,0xBF,0xB0,0x40,0xB0), # pellets
                  (0x06,0xBF,0x90,0x40,0x90),(0x06,0xBF,0x70,0x40,0x70), # pellets
                  (0x06,0xBF,0xF0,0x40,0xF0), # pellets
                  (0x00,0xD3,0xDA,0xD3,0xF6),(0x01,0x63,0xD8,0x63,0xF8), # ladders bottom girder - girder 1
                  (0x00,0x73,0xB8,0x73,0xD8),(0x00,0x2B,0xBA,0x2B,0xD6), # ladders girder 1 - girder 2 
                  (0x01,0x53,0x98,0x53,0xB8),(0x00,0x83,0x98,0x83,0xB8),(0x00,0xD3,0x9A,0xD3,0xB6), # ladders girder 2 - girder 3
                  (0x00,0x2B,0x7A,0x2B,0x96),(0x00,0x5B,0x78,0x5B,0x98),(0x01,0xBB,0x78,0xBB,0x98), # ladders girder 3- girder 4
                  (0x01,0x6B,0x54,0x6B,0x78),(0x00,0xD3,0x56,0xD3,0x76),(0,0,0,0,0) ) # ladders girder 4 - top girder
...
#                  (0x02,0x3F,0x97,0x10,0x95),(0x02,0xBF,0x98,0x40,0x98),(0x02,0xDF,0x9A,0xC0,0x98), # girder 3
#                  (0x02,0x3F,0x79,0x20,0x7A),(0x02,0xBF,0x78,0x40,0x78),(0x02,0xEF,0x75,0xC0,0x77), # girder 4
#                  (0x00,0xBB,0xD8,0xBB,0xF8),(0x01,0x63,0xD8,0x63,0xF8), # ladders bottom girder - girder 1
#                  (0x00,0x73,0xB8,0x73,0xD8),(0x00,0x2B,0xBA,0x2B,0xD6), # ladders girder 1 - girder 2 
#                  (0x01,0x53,0x98,0x53,0xB8),(0x00,0x83,0x98,0x83,0xB8),(0x00,0xD3,0x9A,0xD3,0xB6), # ladders girder 2 - girder 3
#                  (0x00,0x2B,0x7A,0x2B,0x96),(0x00,0x5B,0x78,0x5B,0x98),(0x01,0xBB,0x78,0xBB,0x98), # ladders girder 3- girder 4
#                  (0x01,0x6B,0x54,0x6B,0x78),(0x00,0xd3,0x56,0xd3,0x76),(0,0,0,0,0) ) # ladders girder 4 - top girder
